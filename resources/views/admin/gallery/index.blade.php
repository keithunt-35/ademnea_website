    ...
    <table id="myTable"class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
        ...
        @foreach($event as $item)
            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                ...
                <td class="px-6 py-4">
                    <!-- Modal toggle -->
                    <a href="#" type="button" data-modal-target="{{ $item[0]->title }}" data-modal-show="{{ $item[0]->title }}" style="color: white; background-color:  #28a745; width: auto; height: 30px; padding: 5px; border-radius: 5px;" class="">View</a>
                    <a href="#" type="button" data-modal-target="{{ $item[0]->id }}" data-modal-show="{{ $item[0]->id}}" style="color: white; background-color:  #ffc107; width: auto; height: 30px; padding: 5px; border-radius: 5px;" class="">Edit</a>

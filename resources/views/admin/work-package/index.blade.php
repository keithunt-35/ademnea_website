    ...
    <table id="myTable"class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
        ...
        @foreach($workpackage as $item)
            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                ...
                <td class="px-6 py-4">
                    <!-- Modal toggle -->
                    <a href="#" type="button" data-modal-target="{{ $item->name }}" data-modal-toggle="{{ $item->name }}" class="font-medium text-green-600 dark:text-blue-500 hover:underline">View</a>
...
document.getElementById("cancel-button").addEventListener("click", function() {
    ...
    window.location.href = "{{ url('admin/work-package') }}"; // Replace with the actual URL of the table page
});
